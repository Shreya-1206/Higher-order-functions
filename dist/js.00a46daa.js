...
exports.renderTotal = exports.renderRows = void 0;
...
const renderTotal = cart => {
  const costTotal = cart.reduce((prev, item) => prev + item.cost * item.quantity, 0).toPrecision(6);
  const quantityTotal = cart.reduce((prev, item) => prev + item.quantity, 0);
...
const renderRows = rows => {
  const domNodes = rows.map(({
    ...
    return (0, _Row.default)(product, quantity, cost.toPrecision(5));
  });
  itemRows.innerHTML = domNodes.join('');
};
exports.renderRows = renderRows;
},{"./Row":"js/Row.js"}],"js/currencyRates.json":[function(require,module,exports) {
module.exports = {
  "USD": 1,
  "INR": 73,
  "EUR": 0.83,
...
const computeCart = function () {
  ...
  recompute(currency, _currencyRates.default, _view.renderRows)(_cart.default); ///double invocation
...
computeCart();
},{"./cart.json":"js/cart.json","./view":"js/view.js","./currencyRates.json":"js/currencyRates.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
